...
from app.v2.models.switch import SwitchDbModelV2
...
def _create_switch(session: Session, fabric_name: str = "f1", switch_id: str = "SAL1111", hostname: str = "leaf1", role: str = "leaf") -> SwitchDbModelV2:
    switch = SwitchDbModelV2(
        switchId=switch_id,
...
def test_v2_switches_post_100(session: Session, client: TestClient):
...
def test_v2_switches_post_200(client: TestClient):
...
def test_v2_switches_get_100(session: Session, client: TestClient):
...
def test_v2_switch_get_200(session: Session, client: TestClient):
...
def test_v2_switch_delete_100(session: Session, client: TestClient):
...
def test_v2_switch_delete_200(session: Session, client: TestClient):
...
def test_v2_switches_summary_100(session: Session, client: TestClient):
...
def test_v2_switch_change_roles_100(session: Session, client: TestClient):
...
def test_v2_switch_change_roles_200(session: Session, client: TestClient):
...
def test_v2_switch_rediscover_100(session: Session, client: TestClient):
...
def test_v2_switch_rediscover_200(session: Session, client: TestClient):
