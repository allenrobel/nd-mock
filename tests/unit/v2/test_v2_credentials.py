...
from app.v2.models.credentials import SwitchCredentialDbModel
from ..common import client_fixture, session_fixture


def test_v2_credentials_switches_get_100(client: TestClient):
...
def test_v2_credentials_switches_get_110(session: Session, client: TestClient):
...
def test_v2_credentials_switches_post_100(client: TestClient):
...
def test_v2_credentials_switches_post_110(session: Session, client: TestClient):
