...
We will add example playbooks once the ND Ansible collection has introduced playbooks for Nexus Dashboard v4.2.  For now, please use e.g. Postman, Bruno, etc.

There are also some [example curl scripts](https://github.com/allenrobel/docs/example_scripts.md) you can modify and try.
...
running nd-mock outside of a container.
