...
arguments:
  - name: endpoint
    description: Path to the endpoint module to test (e.g., app/v1/endpoints/manage/fabrics/fabric_get.py)
    required: true
---
...
- Test function names follow pattern: `test_{version}_{resource}_{method}_{number}` (e.g., `test_v1_fabric_post_100`)
