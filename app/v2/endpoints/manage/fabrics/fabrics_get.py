...
from ....models.fabric import FabricDbModelV2, FabricResponseModel, FabricsListMeta, FabricsListResponse
...
def v2_fabrics_get(
    *,
    ...
    """
    try:
        total = session.exec(select(func.count()).select_from(FabricDbModelV2)).one()
