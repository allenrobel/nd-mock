...
from .....models.switch import ChangeSwitchRoleResponse, SwitchDbModelV2, SwitchOperationStatus, SwitchRoleBody
...
def v2_switch_change_roles_post(
    *,
    ...
    for role_data in body.switchRoles:
        db_switch = session.get(SwitchDbModelV2, role_data.switchId)
