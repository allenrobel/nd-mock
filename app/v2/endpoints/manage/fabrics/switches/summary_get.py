...
from .....models.switch import CounterNameValue, SwitchDbModelV2, SwitchesSummaryResponse
...
def v2_switches_summary_get(
    *,
    ...
    db_switches = session.exec(select(SwitchDbModelV2).where(SwitchDbModelV2.fabricName == fabric_name)).all()
